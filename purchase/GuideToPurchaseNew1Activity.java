...
public final class GuideToPurchaseNew1Activity extends zo implements Cdo {
    public static final /* synthetic */ int p = 0;
    public final fd l = new fd(this, 14);
    public final zb2[] m = ew3.F();
    public final ui1 n = m20.D0(kj1.f2953a, new tc0(this, 11));
    public int o;
    ...
    public final void a0(Bundle bundle) {
        ...
        final int i = 0;
        Z().f2708b.setOnClickListener(new View.OnClickListener(this) { // from class: k61

            /* renamed from: b, reason: collision with root package name */
            public final /* synthetic */ GuideToPurchaseNew1Activity f2897b;
            ...
            public final void onClick(View view) {
                String str;
                int i2 = i;
                GuideToPurchaseNew1Activity guideToPurchaseNew1Activity = this.f2897b;
                switch (i2) {
                    case 0:
                        if (guideToPurchaseNew1Activity.o == 1) {
                            ew3.b0(new d9(16));
                        } else {
                            ew3.a();
                            du.d(279, null);
                        ...
                        guideToPurchaseNew1Activity.finish();
                        return;
                    case 1:
                        ...
                        ew3.Q("click", y, str);
                        l61 l61Var = new l61(guideToPurchaseNew1Activity, 1);
                        yc2.a();
                        l61Var.invoke(GoogleIABHelper.g);
                        du.d(638, null);
                        return;
                    case 2:
                        int i4 = GuideToPurchaseNew1Activity.p;
                        view.setSelected(true);
                        guideToPurchaseNew1Activity.Z().g.setSelected(false);
                        return;
                    case 3:
                        int i5 = GuideToPurchaseNew1Activity.p;
                        view.setSelected(true);
                        guideToPurchaseNew1Activity.Z().h.setSelected(false);
                        return;
                    case 4:
                        int i6 = GuideToPurchaseNew1Activity.p;
                        Bundle bundle2 = new Bundle();
                        bundle2.putBoolean("isFromGuide", true);
                        bx3.G(guideToPurchaseNew1Activity.c, true, bundle2);
                        return;
                    case 5:
                        int i7 = GuideToPurchaseNew1Activity.p;
                        d42 d42Var = d42.n;
                        yc2.a();
                        d42Var.invoke(GoogleIABHelper.g);
                        return;
                    case 6:
                        int i8 = GuideToPurchaseNew1Activity.p;
                        tf3.h0(guideToPurchaseNew1Activity, WebViewActivity.class, tf3.r(new n42("intentTargetUrl", tf3.f() + "&dark=" + v73.l()), new n42("intentTitle", guideToPurchaseNew1Activity.getTitle())), 0, 4);
                        return;
                    default:
                        int i9 = GuideToPurchaseNew1Activity.p;
                        tf3.h0(guideToPurchaseNew1Activity, WebViewActivity.class, tf3.r(new n42("intentTargetUrl", tf3.g() + "&dark=" + v73.l()), new n42("intentTitle", guideToPurchaseNew1Activity.getTitle())), 0, 4);
                        return;
                }
            }
        });
        final int i2 = 1;
        Z().c.setOnClickListener(new View.OnClickListener(this) { // from class: k61
        ...
        final int i3 = 2;
        constraintLayout.setOnClickListener(new View.OnClickListener(this) { // from class: k61
            ...
            public final void onClick(View view) {
                ...
                switch (i22) {
                    case 0:
                        ...
                        return;
                    case 1:
                        int i32 = GuideToPurchaseNew1Activity.p;
                        String y = ew3.y();
                        if (guideToPurchaseNew1Activity.Z().h.isSelected()) {
                            str = ew3.z().f5459a;
                        } else {
        ...
        final int i4 = 3;
        constraintLayout2.setOnClickListener(new View.OnClickListener(this) { // from class: k61
            ...
            public final void onClick(View view) {
                ...
                switch (i22) {
                    ...
                    case 1:
                        ...
                        return;
                    case 2:
                        int i42 = GuideToPurchaseNew1Activity.p;
                        view.setSelected(true);
                        guideToPurchaseNew1Activity.Z().g.setSelected(false);
                        return;
                    case 3:
        ...
        ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan() { // from class: com.security.xvpn.z35kb.purchase.GuideToPurchaseNew1Activity$initViews$6$1$highLightStyle$1
        ...
        ForegroundColorSpan foregroundColorSpan2 = new ForegroundColorSpan() { // from class: com.security.xvpn.z35kb.purchase.GuideToPurchaseNew1Activity$initViews$6$1$highLightStyle2$1
            @Override // android.text.style.ForegroundColorSpan, android.text.style.CharacterStyle
            public final void updateDrawState(TextPaint textPaint) {
                super.updateDrawState(textPaint);
                textPaint.setTypeface(n01.c());
        ...
        d0(Z().f, AppCompatTextView.class, new l61(this, i3));
        d0(Z().f, BorderLinearLayout.class, new l61(this, i4));
        final int i5 = 4;
        Z().r.setOnClickListener(new View.OnClickListener(this) { // from class: k61
            ...
            public final void onClick(View view) {
                ...
                switch (i22) {
                    ...
                    case 2:
                        ...
                        return;
                    case 3:
                        int i52 = GuideToPurchaseNew1Activity.p;
                        view.setSelected(true);
                        guideToPurchaseNew1Activity.Z().h.setSelected(false);
                        return;
                    case 4:
        ...
        final int i6 = 5;
        Z().q.setOnClickListener(new View.OnClickListener(this) { // from class: k61
            ...
            public final void onClick(View view) {
                ...
                switch (i22) {
                    ...
                    case 3:
                        ...
                        return;
                    case 4:
                        int i62 = GuideToPurchaseNew1Activity.p;
                        Bundle bundle2 = new Bundle();
                        bundle2.putBoolean("isFromGuide", true);
                        bx3.G(guideToPurchaseNew1Activity.c, true, bundle2);
                        return;
        ...
        final int i7 = 6;
        Z().k.setOnClickListener(new View.OnClickListener(this) { // from class: k61
            ...
            public final void onClick(View view) {
                ...
                switch (i22) {
                    ...
                    case 4:
                        ...
                        return;
                    case 5:
                        int i72 = GuideToPurchaseNew1Activity.p;
                        d42 d42Var = d42.n;
                        yc2.a();
                        d42Var.invoke(GoogleIABHelper.g);
                        return;
        ...
        final int i8 = 7;
        Z().l.setOnClickListener(new View.OnClickListener(this) { // from class: k61
            ...
            public final void onClick(View view) {
                ...
                switch (i22) {
                    ...
                    case 5:
                        ...
                        return;
                    case 6:
                        int i82 = GuideToPurchaseNew1Activity.p;
                        tf3.h0(guideToPurchaseNew1Activity, WebViewActivity.class, tf3.r(new n42("intentTargetUrl", tf3.f() + "&dark=" + v73.l()), new n42("intentTitle", guideToPurchaseNew1Activity.getTitle())), 0, 4);
                        return;
                    default:
                        int i9 = GuideToPurchaseNew1Activity.p;
        ...
        l61 l61Var = new l61(this, i);
        ContentWrapper contentWrapper = this.k;
        if (contentWrapper != null) {
            contentWrapper.f372a.add(l61Var);
            l61Var.invoke(contentWrapper.f373b);
        }
        Z().i.post(new g53(this, 5));
        ...
        if (zb2Var.c == 0) {
            ...
            bx3.i(valueOf2, pd0.y(R.string.StartGuideFreeTryHighlight), new ForegroundColorSpan() { // from class: com.security.xvpn.z35kb.purchase.GuideToPurchaseNew1Activity$initProduct$1$1$highLightStyle$1
                @Override // android.text.style.ForegroundColorSpan, android.text.style.CharacterStyle
                public final void updateDrawState(TextPaint textPaint) {
                    super.updateDrawState(textPaint);
                    textPaint.setTypeface(n01.c());
        ...
        if (zb2Var2.c == 0) {
            ...
            bx3.i(valueOf3, pd0.y(R.string.StartGuideFreeTryHighlight), new ForegroundColorSpan() { // from class: com.security.xvpn.z35kb.purchase.GuideToPurchaseNew1Activity$initProduct$2$1$highLightStyle$1
                @Override // android.text.style.ForegroundColorSpan, android.text.style.CharacterStyle
                public final void updateDrawState(TextPaint textPaint) {
                    super.updateDrawState(textPaint);
                    textPaint.setTypeface(n01.c());
        ...
        fl.h(this, Z().f2708b, 1000024);
        fl.n(this, Z().t, 1000098);
        fl.n(this, Z().o, 1000098);
        fl.n(this, Z().u, 1000098);
        fl.n(this, Z().p, 1000098);
        bindInvalidate(Z().h);
        bindInvalidate(Z().g);
        fl.n(this, Z().r, 1000119);
        fl.n(this, Z().q, 1000119);
